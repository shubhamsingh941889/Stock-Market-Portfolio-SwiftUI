                          ...
                          .toolbar {
                            ToolbarItem(placement: .navigationBarTrailing) {
                              ...
                              Button(action:
                                  ...
                                  print("exists",favoritesViewModel.checkFavExists(ticker: ticker))

                                  if favoritesViewModel.checkFavExists(ticker: ticker)
                                  {
...
//                                      print("add")
                                      favoritesViewModel.addFavorites(ticker: ticker, name:companyViewModel.ProfileArray[0].name)
                                      print("fav",favoritesViewModel.favoritesArray)
